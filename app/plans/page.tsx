  ...
  const plans: Plan[] = [
    {
      ...
      image: "/images/plans/super-sale.png",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <nav className="bg-black/20 backdrop-blur-sm border-b border-white/10 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <h1 className="text-lg sm:text-xl font-bold text-white">
            The Arleen Credit Repair Program
          </h1>
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
        {/* Sidebar with Sasha's Profile */}
        <div className="lg:w-80 p-4 lg:p-6 mx-8 flex-shrink-0">
          <Card className="bg-black/60 border-white/20 text-white rounded-3xl h-full">
            <CardContent className="p-6 text-center flex flex-col justify-center h-full">
              <div className="mb-6">
                <Image
                  src="/images/sasha-profile.png"
                  alt="Sasha Yvonne"
                  width={200}
                  height={200}
