...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-4 sm:py-8 px-4">
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="bg-black/20 border-white/20 text-white text-sm sm:text-base"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="ssn" className="text-sm sm:text-base">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => handleInputChange("state", value)}>
                      <SelectTrigger className="bg-black/20 border-white/20 text-white text-sm sm:text-base">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="currentCreditScore" className="text-sm sm:text-base">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="goalCreditScore" className="text-sm sm:text-base">
                      Goal Credit Score
                    </Label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="employmentStatus" className="text-sm sm:text-base">
                      Employment Status
                    </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="housingStatus" className="text-sm sm:text-base">
                    Housing Status
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="bankruptcyHistory" className="text-sm sm:text-base">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="creditGoals" className="text-sm sm:text-base">
                  ...
                  <Textarea
                    ...
                    className="bg-black/20 border-white/20 text-white placeholder:text-gray-400 text-sm sm:text-base min-h-[100px]"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="hearAboutUs" className="text-sm sm:text-base">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  />
                  <Label htmlFor="credit" className="text-xs sm:text-sm leading-relaxed">
